				...
				<div class="row pt-4">
					<div class="col-lg-6">
						<p class="mb-2 text-center text-lg-start">Copyright &copy;<script>
							...
							</script>. All Rights Reserved. &mdash; Designed with love by <a href="https://untree.co">Dhaval Patel</a> Distributed By <a hreff="https://themewagon.com">Palladium Hub</a> <!-- License information: https://untree.co/license/ -->
						</p>
					</div>
